...
const MUTATIONS = [
  ...
  },
  {
    ...
    file: SWEEP,
    from: `    if (!holdOn) { releases.push({ ...base, why: "holding is off — nothing waits for a tap" }); continue; }`,
    to: ``,
  ...
  },
  {
    ...
    file: SWEEP,
    from: `    if (releaseMs != null && nowMs >= releaseMs + RELEASE_GRACE_MS) { releases.push({ ...base, why: \`release window more than \${RELEASE_GRACE_MS / 3600000}h past\` }); continue; }`,
    to: ``,
    nodeTests: SWEEP_TESTS,
  },
  {

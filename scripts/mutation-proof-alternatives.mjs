...
const MUTATIONS = [
  ...
  {
    id: "G21d",
    guard: "The hover grid carries the same four-axis difference — opacity alone left an unavailable tile reading as an ordinary blue chip",
    file: CHIP,
    kind: "behavioural",
  ...
  {
    id: "G25b",
    guard: "A merged-away record that a broken pointer chain resolved to is never offered for sale",
    file: APP,
    kind: "source-pin",
  ...
  },
  {
    ...
    file: APP,
    kind: "source-pin",
    from: `        if (!sneakerGateReady(hub)) return false;`,
    to: ``,
  },
  {
    id: "G25c",
    guard: "A RETIRED line is never RECOMMENDED — deadForOrder is Pine-exempt and would let one through there",
    file: APP,
    kind: "source-pin",
    from: `      isSellable: (p) => !isDeactivated(p) && !isMergedAway(p)`,

...
import { transferTargets, labelFor, allLocationIds, IN_TRANSIT } from "./locations";
...
export function SeatRow({ seat, product, label, registry, locations, destinations, ctx, viewer, expanded, onToggle, onDone, onFail }) {

...
const RoleIcons = {
  ...
  assistant: (
    // Brighter accent + a touch more weight so the bag reads crisp on the dark
    // chip (the #4A7FFF was too dim/soft on the near-black tile).
    <svg viewBox="0 0 24 24" width="30" height="30" stroke="#6A9FFF" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
